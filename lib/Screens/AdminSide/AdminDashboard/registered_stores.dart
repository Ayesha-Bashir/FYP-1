      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
            ...
            _buildTextField(storeNameController, 'Enter Admin Name'),
            const SizedBox(height: 10),
            _buildTextField(storePhoneNumberController, 'Enter Admin Email'),
            const SizedBox(height: 10),
            _buildTextField(storeAboutController, 'Enter Admin Password'),
